...
export class LadyHemlock {
  ...
  activate() {
    ...
    const nameCard = this.scene.add.text(GAME_WIDTH / 2, GAME_HEIGHT / 2 - 20, 'LADY HEMLOCK', {
      fontSize: '28px', fontFamily: 'Arial, Helvetica, sans-serif', color: '#44cc44',
      fontStyle: 'bold', stroke: '#000000', strokeThickness: 4,
    }).setOrigin(0.5).setScrollFactor(0).setDepth(300).setAlpha(0);

    const subtitle = this.scene.add.text(GAME_WIDTH / 2, GAME_HEIGHT / 2 + 15, 'The Blighted Queen', {
